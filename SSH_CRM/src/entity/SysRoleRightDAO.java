 ...
 * 
 * @see entity.SysRoleRight
 * @author MyEclipse Persistence Tools
 */

public class SysRoleRightDAO extends HibernateDaoSupport {
	...
	public static SysRoleRightDAO getFromApplicationContext(
			ApplicationContext ctx) {
		return (SysRoleRightDAO) ctx.getBean("SysRoleRightDAO");
	}
}