...
public class SysRightDAO extends HibernateDaoSupport {
	...
	public static SysRightDAO getFromApplicationContext(ApplicationContext ctx) {
		return (SysRightDAO) ctx.getBean("SysRightDAO");
	}
}